...
import { SurveyMeta, SurveyQuestion } from '@api/types';
...
export default function SurveyCreator() {
  ...
  const [questions, setQuestions] = useState<SurveyQuestion[]>(state?.initialQuestions || []);
            ...
            columnDefinitions={[
              ...
              },
              {
                ...
                editConfig: {
                  ...
                  editIconAriaLabel: tString('surveyCreator.editable'),
                  disabledReason: (item: SurveyQuestion) => {
                    if (item.type === "text") {
                  ...
                  editingCell: (item: SurveyQuestion, { currentValue, setValue }) => (
                    <Textarea
                      ...
                      onChange={event => setValue(event.detail.value)}
                      onBlur={event => {
                        if (!event.detail) return; // detail이 null이면 함수 종료
