...
// 로깅 설정을 위한 추가 임포트
import { ConsoleLogger, LoggingCategory, LoggingLevel } from 'aws-amplify/utils';
...
// 로깅 설정 - Amplify v6 방식
ConsoleLogger.LOG_LEVEL = LoggingLevel.DEBUG;

// 특정 카테고리만 로깅 설정하기 (선택 사항)
ConsoleLogger.setLevel(LoggingCategory.Auth, LoggingLevel.DEBUG);
ConsoleLogger.setLevel(LoggingCategory.API, LoggingLevel.DEBUG);
