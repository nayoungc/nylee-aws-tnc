...
def create_course_catalog_tables():
    """AWS 교육 과정 관련 모든 DynamoDB 테이블들을 생성합니다."""
    ...
    tables_to_create = [
        ...
        'Tnc-CourseCatalog-Materials',
        'Tnc-CourseCatalog-Quizzes',
        'Tnc-CourseCatalog-Questions',
        'Tnc-CourseCatalog-Surveys',
        'Tnc-CourseCatalog-SurveyQuestions',
        'Tnc-Courses',
        'Tnc-Course-UserQuizzes',
        'Tnc-Course-UserResponses',
        'Tnc-Course-UserSurveys',
        'Tnc-Course-UserSurveyResponses',
        'Tnc-SurveyAnalytics',
        'Tnc-DashboardMetrics',
        'Tnc-Customers'
    ]
    ...
    # 테이블 생성 완료 대기
    essential_tables = ['Tnc-CourseCatalog', 'Tnc-CourseCatalog-Modules', 'Tnc-CourseCatalog-Labs']
